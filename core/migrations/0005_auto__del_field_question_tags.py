...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Question.tags'
        db.delete_column('core_question', 'tags')


    def backwards(self, orm):
        
        # Adding field 'Question.tags'
        db.add_column('core_question', 'tags', self.gf('tagging.fields.TagField')(default=''), keep_default=False)
