...
class TagManager(models.Manager):
    ...
    def add_tag(self, obj, tag_name):
        ...
        tag, created = self.get_or_create(name=tag_name)
        ctype = ContentType.objects.get_for_model(obj)
        result = TaggedItem._default_manager.get_or_create(
...
#        print query % (extra_joins, extra_criteria, min_count_sql), params
        ...
        for row in cursor.fetchall():
            ...
            tags.append(t)
        return tags
    def usage_for_model_group(self, model, counts=False, min_count=None, filters=None, group=None):
        """
    ...
    def cloud_for_model(self, model, steps=4, distribution=LOGARITHMIC,
                        filters=None, min_count=None, group=None):
        """
        Obtain a list of tags associated with instances of the given
	...
	tags = list()
	if group:
	    tags = list(self.usage_for_model_group(model, counts=True, filters=filters,
						min_count=min_count, group=group))
	else:
